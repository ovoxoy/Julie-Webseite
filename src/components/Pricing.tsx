                        ...
                        <div className="p-8 md:p-10 flex-grow">
                            ...
                            <div className="space-y-4 text-gray-600 leading-relaxed mb-8">
                                <p>
                                    ...
                                    so zahlen Sie nur das, was Ihr Pferd wirklich benötigt.
                                </p>
                            </div>
                            ...
                            <div className="bg-brand-cream rounded-2xl p-6 border border-brand-light/50 flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600 italic">
                                        "Im Mittelpunkt steht für mich immer die Qualität der Behandlung. Eine Sitzung endet nicht nach einer festen Minute, sondern dann, wenn Ihr Pferd optimal versorgt ist oder eine Pause benötigt."
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-brand-dark text-white p-8 rounded-3xl shadow-lg text-center relative overflow-hidden">
                            <div className="relative z-10">
                                ...
                                <p className="text-brand-light/70 text-sm mb-6">
                                    Ich berate Sie gerne unverbindlich vor Ihrem ersten Termin.
                                </p>
