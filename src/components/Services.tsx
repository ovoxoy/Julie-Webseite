...
const services: ServiceItem[] = [
  ...
  },
  {
    id: '5',
    title: 'Reha-Planung',
    description: 'Begleitung nach Verletzungen oder Operationen sowie bei chronischen Problemen mit dem Ziel kontrolliert die Belastung zu steigern, funktionelle Bewegungsmuster zu verbessern und die Regeneration nachhaltig zu gestalten.',
